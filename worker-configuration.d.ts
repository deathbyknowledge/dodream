/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6e8f29cb2a0f655f5e130537a54d02c)
// Runtime types generated with workerd@1.20250525.0 2025-03-05 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		INFERENCE_URL: "https://api.moondream.ai/v1/";
		MOONDREAM_API_KEY: string;
		MOONDREAM: DurableObjectNamespace<import("./src/worker").Moondream>;
		ASSETS: Fetcher;
	}
}
